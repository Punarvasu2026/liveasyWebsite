...
const FreightSection1 = ({ imageSrc, heading, text }) => {
  return (
    <section className="flex flex-col items-center bg-white w-full px-4 sm:px-6 lg:px-10 pt-[40px] pb-[40px] sm:pt-20 sm:pb-20 mx-auto">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-[48px] sm:gap-[80px] w-full max-w-[1280px] h-auto">
        ...
        {/* Text Container */}
        <div className="w-full sm:w-[582px] min-h-[314px] flex flex-col gap-4 sm:gap-6">
          <h2 className="text-[#1D2B7F] text-[24px] sm:text-[32px] font-bold leading-tight">
            {heading}
          </h2>
          <p className="text-[#444] text-sm sm:text-base font-[18px]">
            {text}
          </p>
        </div>
      </div>
