...
import { FaYoutube, FaLinkedinIn, FaTimes } from "react-icons/fa";
...
<div className="flex flex-col md:grid md:grid-cols-3 gap-8 md:gap-[80px] flex-1 text-sm w-full">
  ...
  <div className="flex flex-col gap-5 md:gap-5">
    ...
    <ul className="[&>li]:mb-0 [&>li+li]:mt-[16px]">
      <li><a href="#" className="hover:underline">Why CargoPro?</a></li>
  ...
  <div className="flex flex-col gap-5 md:gap-5">
    ...
    <ul className="[&>li]:mb-0 [&>li+li]:mt-[16px]">
      ...
      <li><a href="#" className="hover:underline">Privacy Policy / GDPR</a></li>
...
<div className="max-w-[1440px] mx-auto mt-10 flex justify-end gap-4 px-4 md:px-0">
  {[FaYoutube, FaLinkedinIn, FaTimes].map((Icon, idx) => (
    <div
      key={idx}
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto mt-6 border-t border-white/30 pt-4 px-4 md:px-0">
        ...
        <p className="text-center text-sm">©CargoPro 2025. All rights reserved</p>
      </div>
    </footer>
  );
};
